...
class CpuPlayerGood(CpuPlayer):
    ...
    def make_move(self, game_board: Board, player_id: int) -> tuple[int, int]:
        """
        ...
        if (ret_value[0]):
            ...
            return (ret_value[1][0], ret_value[1][1])
        ...
        if fork_move:
            ...
            return (fork_move[0], fork_move[1])
        ...
        if len(opponent_forks) == 1:
            ...
            return (opponent_forks[0][0], opponent_forks[0][1])
            ...
            if threat_move:
                ...
                return (threat_move[0], threat_move[1])
        ...
        return (-1, -1) # NOTE: this will never be executed
