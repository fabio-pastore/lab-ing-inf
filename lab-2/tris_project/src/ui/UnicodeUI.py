...
class UnicodeUI(BaseUI):

    # NOTE: this UI only supports 3x3 boards for the time being.

    FIRST_ROW_DELIMITER: str = "┏━━━┳━━━┳━━━┓"
    ROW_DELIMITER: str = "┣━━━╋━━━╋━━━┫"
    LAST_ROW_DELIMITER: str = "┗━━━┻━━━┻━━━┛"
    PLAYER_ONE_CHAR: str = "×"
    PLAYER_TWO_CHAR: str = "●"
    ...
    def display_board(self) -> None:
        ...
        for i in range(Board.NUM_BOARD_RC):
            print(UnicodeUI.FIRST_ROW_DELIMITER) if i == 0 else print(UnicodeUI.ROW_DELIMITER)
            ...
            print("┃")
        print(UnicodeUI.LAST_ROW_DELIMITER)
