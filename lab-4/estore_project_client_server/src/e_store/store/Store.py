...
class Store():
    ...
    def get_items(self) -> list[tuple[GenericItem, int]]:
        return self.item_stock.get_all_items()
    ...
    def search_item(self, item_id: int) -> GenericItem | None:
        """
    ...
    def get_available_quantity(self, item: GenericItem) -> int | None:
        return self.item_stock.get_item_quantity(item)
